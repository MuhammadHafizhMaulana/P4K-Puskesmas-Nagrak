    ...
    <div id="formDonorDarah">
        ...
        <div class="w-100">
            ...
            <div class="row">
                ...
                <div class="col-1 d-none d-sm-block">:</div>
                <div class="col-12 col-sm-6 ms-2 mb-2 m-sm-0  text-start">
                    <?php echo $data['saldo_tabungan'] ? 'Rp. '. $data['saldo_tabungan'] : '-' ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ms-2 mb-2 ms-sm-0  text-start">
                    ...
                    <button style="display:contents" onclick="openPhotoDialog('ktp', `<?= $data['id_user'] ?>`)"
                        ...
                        <div id="photoKTP" class="boxPhoto rounded-3 border border-2 border-primary"
                            style='background-image: url("./proses/getUserKTP.php?id=<?= $data["id_user"] ?>");'>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ms-2 mb-2 ms-sm-0  text-start">
                    ...
                    <button style="display:contents" onclick="openPhotoDialog('kk', `<?= $data['id_user'] ?>`)"
                        ...
                        style="border: none; padding: 0">
                        <div id="photoKTP" class="boxPhoto rounded-3 border border-2 border-primary"
                            style='background-image: url("./proses/getUserKK.php?id=<?= $data["id_user"] ?>");'>
                            <div class="photoDescription w-100 h-100 rounded-2">
                                <h4 class="text-white">Klik untuk melihat detail</h4>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ms-2 mb-2 ms-sm-0  text-start">
                    ...
                    <button style="display:contents" onclick="openPhotoDialog('pas_foto', `<?= $data['id_user'] ?>`)"
                        ...
                        style="border: none; padding: 0">
                        <div id="photoKTP" class="boxPhoto rounded-3 border border-2 border-primary"
                            style='background-image: url("./proses/getUserPasFoto.php?id=<?= $data["id_user"] ?>");'>
                            <div class="photoDescription w-100 h-100 rounded-2">
                                <h4 class="text-white">Klik untuk melihat detail</h4>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ms-2 mb-2 ms-sm-0  text-start">
                    ...
                    <button style="display:contents" onclick="openPhotoDialog('rekomendasi', `<?= $data['id_user'] ?>`)"
                        ...
                        style="border: none; padding: 0">
                        <div id="photoKTP" class="boxPhoto rounded-3 border border-2 border-primary"
                            style='background-image: url("./proses/getUserRekomendasi.php?id=<?= $data["id_user"] ?>");'>
                            <div class="photoDescription w-100 h-100 rounded-2">
                                <h4 class="text-white">Klik untuk melihat detail</h4>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ms-2 mb-2 ms-sm-0  text-start">
                    ...
                    <button style="display:contents" onclick="openPhotoDialog('rujukan', `<?= $data['id_user'] ?>`)"
                        ...
                        style="border: none; padding: 0">
                        <div id="photoKTP" class="boxPhoto rounded-3 border border-2 border-primary"
                            style='background-image: url("./proses/getUserRujukan.php?id=<?= $data["id_user"] ?>");'>
                            <div class="photoDescription w-100 h-100 rounded-2">
                                <h4 class="text-white">Klik untuk melihat detail</h4>
                            </div>
                        </div>
