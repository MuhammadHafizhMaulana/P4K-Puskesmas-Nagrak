...
<head>
    ...
    <title>Detail Kesehatan User</title>
    ...
    <div id="boxKesehatanUser">
        ...
        <div class="w-100">
            ...
            <div class="row">
                ...
                <div class="col-1 d-none d-sm-block">:</div>
                <div class="col-12 col-sm-6 ms-2 mb-2 m-sm-0  text-start">
                    <?php echo $usia_kandungan ?> Pada Saat Ini
                </div>
            </div>
            <div class="row">
        ...
        <div class="alert alert-primary text-center">
            <h6>User atas nama <?php echo $ambil_nama['nama'] ?> belum melakukan penginputan data pendonor</h6>
        </div>
        <?php } ?>
        <?php } else { ?>
        <br>
