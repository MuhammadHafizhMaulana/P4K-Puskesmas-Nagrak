...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE `pembiayaan` SET deskripsi=? WHERE id_user=?";
    ...
    if ($stmt) {
        ...
        if ($result) {
            ...
            header("Location: ../pembiayaan_user.php?id=$id_user&success=update_successful");
            exit();
        } else {
            // Redirect dengan parameter gagal
            header("Location: ../pembiayaan_user.php?id=$id_user&gagal=update_gagal");
            exit();
        }
