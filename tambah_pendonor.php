...
<head>
    ...
    <title>Form Tambah Pendonor</title>
...
<body>
    ...
    <div id="formDonorDarah">
        ...
        <form action="proses/tambah_pendonor_proses.php" method="post">
            ...
            <input type="hidden" id="nomorHP" name="nomorHP" value="<?php echo strtoupper($nomorHPPendonor); ?>"
                required>
        ...
        <form action="proses/cek_pendonor_proses.php" method="post">
            <div class="form-group">
                ...
                <input oninput="checkButtonSubmitNamaNomorForm()" type="text" class="form-control" id="nama" name="nama"
                    placeholder="Masukan nama lengkap pendonor" required>
            </div>
            <div class="form-group">
